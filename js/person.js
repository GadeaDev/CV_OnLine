var person = {
    ...
    jobs: [
...

        {
            ...
            year_from: 2017,
            year_to: 2019,
            tareas: "Responsable de la gestión administrativa y servicios contratados, supervisión, seguimiento, control de desarrollo y consecución satisfactoria de los objetos contractuales, negociación, implementación y gestión de todos los aspectos contractuales de la organización, participar en los procesos de contratación de servicios elaborando volumetrías de servicios y elaboración de planes de contratación, velar por la correcta carga en Sistema SAP de las valuaciones de pagos para los diferentes contratos en ejecución, atención a proveedores, atención al cliente, gestión de personal bajo el cargo.",
        },
        {
            company: "“PDVSA” PETROLEOS DE VENEZUELA S.A., Anzoategui - Venezuela",
            ...
            year_from: 2010,
            year_to: 2017,
            tareas: "Administrador de contratos velando por el cumplimiento de las obligaciones establecidas en la Ley de Contrataciones Públicas, control de ejecución de proyectos y servicios contratados, modificaciones y cierres de contratos, manejo de presupuesto, control de proyectos de obras civiles y servicios comerciales, carga en sistema SAP de las valuaciones de pagos para los diferentes contratos en ejecución, atención a proveedores, atención al cliente.",
        },
        {
            company: "“PDVSA” PETROLEOS DE VENEZUELA S.A., Anzoategui - Venezuela",
            ...
            year_from: 2010,
            year_to: 2010,
            tareas: "Gestión de implantación de Sistemas de información que permiten el registro de Ordenes de Servicios de mantenimiento para controlar la volumetría del trabajo en actividades de mantenimiento de instalaciones y ejecución de obras civiles mediante la generación de tickets de servicios para el personal encargado de ejecutar dichas actividades, Control y Seguimiento de Proyectos y manejo de presupuesto.",
        },
        {
            company: "“PDVSA” PETROLEOS DE VENEZUELA S.A., Anzoategui - Venezuela",
            ...
            year_from: 2007,
            year_to: 2009,
            tareas: "Manejo del Recurso Humano, Desarrollo de Carrera, Planes de Desarrollo y Crecimiento personal, Captación de Personal, elaboración de plan de vacaciones del personal, gestionar planes de jubilación y reemplazo de personal, elaboración de estructura organizacional de la Gerencia.",
        },
        {
            company: "“PDVSA” PETROLEOS DE VENEZUELA S.A., Anzoategui - Venezuela",
            ...
            year_from: 2005,
            year_to: 2007,
            tareas: "Planificación y seguimiento de Indicadores de Gestión Administrativa mediante el uso de tableros de control estadísticos (BALANCE SCORE CARD) apoyo directo a la Gerencia en la planificación estratégica y cumplimiento de objetivos, evaluación de resultados ",
        },
    ],
